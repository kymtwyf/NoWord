...
public class SendMail
{
	...
	public void sendEmail(String userName,String code,String email)
	{
		...
		//设置标题
		sendMail.setSubject("No-Word---注册成功！");
		//设置内容
		sendMail.setContent("尊敬的"+userName+":");
		sendMail.setContent("您在No-Word的账号已经开通，密码是"+code+"，点击以下链接激活账户：");
		if (sendMail.send())
		{
